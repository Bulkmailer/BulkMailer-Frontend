        ...
        <div id="siderdiv">
          ...
          <div>
            <form onSubmit={handlesubmit} id="scheduleform">
              <label htmlFor="date" id="formlabel">
                Date
              </label>
              <div id="flexkro">
                <select
                ...
                <select
                  ...
                  className="forminput5"
                  required
                  disabled={year == null || year == 0 ? true : false}
                >
                ...
                <select
                  ...
                  className="forminput5"
                  required
                  disabled={month == null || month == 0 ? true : false}
                >
                  <option>{dateoptions}</option>
                </select>
              </div>
              <label htmlFor="time" id="formlabel">
                Time
              </label>
              <div id="flexkro">
                <select
                  ...
                  className="forminput5"
                  required
                  disabled={date == null || date == 0 ? true : false}
                >
                ...
                <select
                  ...
                  className="forminput5"
                  required
                  disabled={hour == null || hour == 0 ? true : false}
                >
                  <option>{minoptions}</option>
                </select>
              </div>
              <button type="submit" id="formbtn11">
                Schedule
              </button>
            </form>
          </div>
